...
const socialLinks = [
  {
    href: "https://www.github.com/acm-stackdev",
    icon: (
      <svg
        width="24"
        height="24"
  ...
  {
    href: "www.linkedin.com/in/aung-chan-myae-7b94042a5",
    icon: (
      <svg
        width="24"
        height="24"
    ...
    <section id="contact" className="section">
      <div className="container lg:grid lg:grid-cols-2 lg:items-stretch ">
        <div className="mb-12 lg:mb-0 lg:flex lg:flex-col">
          <h2 className="headline-2 lg:max-[12ch] reveal-up">
        ...
        <form
          action="https://getform.io/f/aqoovqwa"
          method="POST"
